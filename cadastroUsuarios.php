...
$usuarios = UsuarioBanco::getFuncionariosEmpresa($empresa->getEmpresaId(), false);
    ...
    <main class="principal">
        ...
        <div class="conteudo_login">
            ...
            <div class="seletor_usuario">
                ...
                <label id="lb_selecionar_usuario" for="lb_selecionar_usuario">Selecione o usuário:</label>
                ...
                <button id="botao_novo_usuario">Novo Usuario</button>
